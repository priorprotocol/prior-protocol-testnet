...
// IMPORTANT: These addresses are synced with client addresses
// VERIFIED CORRECT ADDRESSES AS OF APRIL 17, 2025
export const TOKEN_CONTRACTS = {
  PRIOR: '0xeFC91C5a51E8533282486FA2601dFfe0a0b16EDb', // Verified correct
  USDC: '0xdB07b0b4E88D9D5A79A08E91fEE20Bb41f9989a2',  // Verified correct
  USDT: '', // Completely removed in new deployment
};

export const SWAP_CONTRACTS = {
  'PRIOR-USDC': '0x8957e1988905311EE249e679a29fc9deCEd4D910', // Verified correct
  'PRIOR-USDT': '', // Completely removed in new deployment
  'USDC-USDT': '',  // Completely removed in new deployment
};

export const FAUCET_CONTRACT = '0xa206dC56F1A56a03aEa0fCBB7c7A62b5bE1Fe419'; // Verified correct
export const PRIOR_NFT_CONTRACT = '0x2a45dfDbdCfcF72CBE835435eD54f4beE7d06D59'; // Verified correct
